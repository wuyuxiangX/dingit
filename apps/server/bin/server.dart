...
import 'package:dingit_server/src/handlers/health_handler.dart';
import 'package:dingit_server/src/handlers/notification_handler.dart';
import 'package:dingit_server/src/middleware/cors_middleware.dart';
import 'package:dingit_server/src/middleware/logger_middleware.dart';
import 'package:dingit_server/src/services/callback_service.dart';
import 'package:dingit_server/src/services/notification_store.dart';
import 'package:dingit_server/src/services/ws_manager.dart';
...
void main(List<String> args) async {
  ...
  print('🚀 Dingit Server running on http://localhost:${server.port}');
